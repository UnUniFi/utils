...
curl -O https://raw.githubusercontent.com/UnUniFi/utils/develop/projects/telescope-extension/editions/ununifi/launch/ununifi-7-private-test/standard/config.js
docker-compose up -d
