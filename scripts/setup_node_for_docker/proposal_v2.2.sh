...
MD5=fca83fd2e03b452d7d3d3fe249c3f5c2
BIN_URL=https://github.com/UnUniFi/chain/releases/download/v2.2.0/ununifid

$BIN_UNI tx gov submit-legacy-proposal software-upgrade v2_2 \
--title upgrade_v2.2 \
--description upgrade \
