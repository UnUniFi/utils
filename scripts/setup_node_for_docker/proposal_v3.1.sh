...
MD5=e73b4b3753e40728dafbb4ff8fcf419b
BIN_URL=https://github.com/UnUniFi/chain/releases/download/v3.1.0/ununifid

$BIN_UNI tx gov submit-legacy-proposal software-upgrade v3_1 \
--title "upgrade v3.1.0" \
--description "Upgrade UnUniFi v3.1.0 at height xx" \
