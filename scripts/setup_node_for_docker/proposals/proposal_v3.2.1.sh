...
MD5=f8bab53e8d87510406910925ef4a4ce7
BIN_URL=https://github.com/UnUniFi/chain/releases/download/v3.2.1/ununifid

$BIN_UNI tx gov submit-legacy-proposal software-upgrade v3_2_1 \
--title "upgrade v3.2.1" \
--description "Upgrade UnUniFi v3.2.1 at height xx" \
