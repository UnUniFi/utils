...
MD5=d1b9c2fe79b0a634393bfda2081505a0
BIN_URL=https://github.com/UnUniFi/chain/releases/download/v3.2.2/ununifid

$BIN_UNI tx gov submit-legacy-proposal software-upgrade v3_2_2 \
--title "upgrade v3.2.2" \
--description "Upgrade UnUniFi v3.2.2 at height $UP_HEIGHT" \
