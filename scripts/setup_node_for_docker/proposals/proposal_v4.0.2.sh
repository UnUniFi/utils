...
MD5=07b45576f54b6089fb89655e3bda8b1f
BIN_URL=https://github.com/UnUniFi/chain/releases/download/v4.0.2/ununifid
...
$BIN_UNI tx gov submit-legacy-proposal software-upgrade v4_0_2 \
--title "upgrade v4.0.2" \
--description "Upgrade UnUniFi v4.0.2 at height xx. More info for v4.0.2, visit GiyHub https://github.com/UnUniFi/chain/releases/tag/v4.0.2" \
