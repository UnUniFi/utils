...
MD5=83fe8e830a673c8682dbc7918cdf1bb2
BIN_URL=https://github.com/UnUniFi/chain/releases/download/v4.0.0/ununifid

$BIN_UNI tx gov submit-legacy-proposal software-upgrade v4 \
--title "upgrade v4.0.0" \
--description "Upgrade UnUniFi v4.0.0 at height xx. More info for v4.0.0, visit GiyHub https://github.com/UnUniFi/chain/releases/tag/v4.0.0" \
